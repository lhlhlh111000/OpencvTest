...
class Camera1 extends CameraViewImpl implements Camera.PreviewCallback {
    ...
    public void onPreviewFrame(byte[] bytes, Camera camera) {
        mCallback.onPreviewFrame(bytes, mCameraParameters.getPreviewSize().width, mCameraParameters.getPreviewSize().height);
    ...
    private void doCameraPreview() {
        ...
        int size = mCameraParameters.getPreviewSize().width * mCameraParameters.getPreviewSize().height;
        size  = size * ImageFormat.getBitsPerPixel(mCameraParameters.getPreviewFormat()) / 8;
        if(0 != size) {
